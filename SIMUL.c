...
void write_to_file(char file_name[20],
        SIMULATIONS *sim1, SIMULATIONS *sim2)
{
FILE *fp;
SIMULATIONS *p;
...
void write_to_file_all(char file_name[20], SIMULATIONS *sim1, SIMULATIONS *sim2)
{
FILE *fp;
SIMULATIONS *p;
